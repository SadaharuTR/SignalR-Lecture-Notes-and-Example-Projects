using ChatRoomExample_Server.Data;
using ChatRoomExample_Server.Models;
...
namespace ChatRoomExample_Server.Hubs
{
    public class ChatHub : Hub
    {
        public async Task GetNickName(string nickName)
        {
            ...
            await Clients.Others.SendAsync("clients", ClientSource.Clients);
        }
